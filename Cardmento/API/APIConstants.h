...
#define  BASE_URL               @"http://cardmento-staging.appspot.com/api/"
//#define  API_IMAGE_FORMAT       @"http://cardmento-staging.appspot.com/api/v1/templates/template/%@/image"
//#define  API_AD_FORMAT          @"http://cardmento-staging.appspot.com/api/v1/templates/ad/%@/image"

// THESE LINES SHOULD NOT BE COMMITTED IF CHANGED
//#define  BASE_URL               @"http://cardmento-prod.appspot.com/api/"
